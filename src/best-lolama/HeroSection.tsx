      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-14">
        <div className="space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              { value: '9 Active g', label: 'Current stores' },
              ...
              <div className="mb-5 flex justify-center sm:mb-6">
                <div className="relative aspect-square w-full max-w-[18rem] sm:max-w-[20rem]">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="aspect-square w-[72%] overflow-hidden rounded-full border-4 border-[#8B4513] bg-white shadow-2xl">
                      <img
                        src={encodeURI('/Images/BEST LOLAMA LOGO.jpg')}
                        alt="Best Lolama Logo"
                        className="h-full w-full object-cover scale-[1.2] sm:scale-[1.4]"
                        style={{
